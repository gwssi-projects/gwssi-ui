    ...
    <el-form label-position="top" :model="selfForm" class="demo-form-stacked">
      <el-form-item label="消息推送">
        <el-row>
          ...
          <el-col :span="18">
            <el-input type="textarea" placeholder="请输入内容" :autosize="{minRows: 2, maxRows: 5}" v-model="selfForm.signUpSuccessText">
            </el-input>
          </el-col>
        </el-row>
      </el-form-item>
      ...
      <el-form-item label="">
        <el-row>
          ...
          <el-col :span="18">
            <el-input type="textarea" placeholder="请输入内容" :autosize="{minRows: 2, maxRows: 5}" v-model="selfForm.auditSuccessText">
            </el-input>
          </el-col>
        </el-row>
      </el-form-item>
      ...
      <el-form-item label="">
        <el-row>
          ...
          <el-col :span="18">
            <el-input type="textarea" placeholder="请输入内容" :autosize="{minRows: 2, maxRows: 5}" v-model="selfForm.auditFailedText">
            </el-input>
          </el-col>
        </el-row>
      </el-form-item>
      ...
      <el-form-item label="">
        <el-row>
          ...
          <el-col :span="18">
            <el-input type="textarea" placeholder="请输入内容" :autosize="{minRows: 2, maxRows: 5}" v-model="selfForm.signInSuccessText">
            </el-input>
          </el-col>
        </el-row>
      </el-form-item>
      ...
      <el-form-item label="">
        <el-row>
          ...
          <el-col :span="18">
            <el-input type="textarea" placeholder="请输入内容" :autosize="{minRows: 2, maxRows: 5}" v-model="selfForm.signInFailedText">
            </el-input>
          </el-col>
        </el-row>
      </el-form-item>
      ...
      <el-form-item label="">
        <el-row>
          ...
          <el-col :span="18">
            <el-input type="textarea" placeholder="请输入内容" :autosize="{minRows: 2, maxRows: 5}" v-model="selfForm.signInDoubleText">
            </el-input>
          </el-col>
        </el-row>
      </el-form-item>
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="4">
            <el-select :disabled="selfForm.remind != '提醒'" v-model="selfForm.remindTime" placeholder="提前几小时">
              <el-option v-for="n of 24" :key="n" :value="n"></el-option>
            </el-select>
          </el-col>
          <el-col :span="10">
      ...
      <el-form-item label="">
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="7">
            <el-input placeholder="0" :disabled="selfForm.useScore != '使用'" size="large" :number="true" v-model="selfForm.useScoreNum">
      ...
      <el-form-item label="活动报名获得积分">
        <el-row :gutter="20">
          ...
          <el-col :span="7">
            <el-input placeholder="0" :disabled="selfForm.signUpScore != '获得积分'" size="large" :number="true" v-model="selfForm.signUpScoreNum">
              <template slot="append">积分</template>
            </el-input>
          </el-col>
        </el-row>
      ...
      <el-form-item label="分享活动获得积分">
        <el-row :gutter="20">
          ...
          <el-col :span="7">
            <el-input placeholder="0" :disabled="selfForm.shareScore != '获得积分'" size="large" :number="true" v-model="selfForm.shareScoreNum">
              <template slot="append">积分</template>
            </el-input>
          </el-col>
        </el-row>
      ...
      <el-form-item label="分享后每个阅读量获得积分">
        <el-row :gutter="20">
          ...
          <el-col :span="7">
            <el-input placeholder="0" :disabled="selfForm.shareReadScore != '获得积分'" size="large" :number="true" v-model="selfForm.shareReadScoreNum">
              <template slot="append">积分</template>
            </el-input>
          </el-col>
          ...
          <el-col :span="7">
            <el-input placeholder="0" :disabled="selfForm.shareReadScore != '获得积分'" size="large" :number="true" v-model="selfForm.shareReadScoreNumMax">
              <template slot="append">积分</template>
            </el-input>
          </el-col>
        </el-row>
      ...
      <el-form-item label="分享后好友报名获得积分">
        <el-row :gutter="20">
          ...
          <el-col :span="7">
            <el-input placeholder="0" size="large" :disabled="selfForm.shareSignUp != '获得积分'" :number="true" v-model="selfForm.shareSignUpNum">
              <template slot="append">积分</template>
            </el-input>
          </el-col>
          <el-col :span="2" style="line-height: 42px;text-align: right;">
          ...
          <el-col :span="7">
            <el-input placeholder="0" size="large" :disabled="selfForm.shareSignUp != '获得积分'" :number="true" v-model="selfForm.shareSignUpNumMax">
              <template slot="append">积分</template>
            </el-input>
          </el-col>
        </el-row>
      ...
      <el-form-item label="用户分享后，页面跳转至">
        ...
        <el-input v-show="selfForm.afterShare == '自定义链接'" placeholder="请输入自定义链接" v-model="selfForm.afterShareLink">
        </el-input>
      </el-form-item>
      ...
      <el-form-item label="用户报名后，页面跳转至">
        ...
        <el-input v-show="selfForm.afterSingUp == '自定义链接'" placeholder="请输入自定义链接" v-model="selfForm.afterSingUpLink">
        </el-input>
